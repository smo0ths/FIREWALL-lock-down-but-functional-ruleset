# LDFRS (PowerShell script) v0.4.8
...
@{Name='✔️ Allow DHCPv4 INBOUND';Program='C:\Windows\System32\svchost.exe';Service='Dhcp';Protocol='UDP';LPort='68';RPort='67';Action='Block';Profile='Any';Direction='Inbound'},
...
@{Name='✔️ Allow DHCPv6 INBOUND';Program='C:\Windows\System32\svchost.exe';Service='Dhcp';Protocol='UDP';LPort='546';RPort='547';Action='Block';Profile='Any';Direction='Inbound'},
...
@{Name='✔️ Disable/Enable/Block Everything OUTBOUND TCP/80 (HTTP)';Program='Any';Service='Any';Protocol='TCP';RPort='80';Action='Block';Profile='Any';Direction='Outbound';Enabled='False'},
...
@{Name='✖ [BLOCK IF NOT USING] MoUsoCoreWorker.exe';Program='C:\Windows\UUS\amd64\MoUsoCoreWorker.exe';Protocol='Any';Action='Block';Profile='Any';Direction='Outbound'},
...
@{Name='✖ [BLOCK IF NOT USING] SIHClient.exe';Program='C:\Windows\System32\SIHClient.exe';Protocol='Any';Action='Block';Profile='Any';Direction='Outbound'},
...
@{Name='✖ [BLOCK IF NOT USING] WaaSMedicAgent.exe';Program='C:\Windows\UUS\amd64\WaaSMedicAgent.exe';Protocol='Any';Action='Block';Profile='Any';Direction='Outbound'},
@{Name='✖ [BLOCK IF NOT USING] WaaSMedicSvc';Program='C:\Windows\System32\svchost.exe';Service='WaaSMedicSvc';Protocol='Any';Action='Block';Profile='Any';Direction='Outbound'},
@{Name='✖ [BLOCK IF NOT USING] WdiSystemHost';Program='C:\Windows\System32\svchost.exe';Service='WdiSystemHost';Protocol='Any';Action='Block';Profile='Any';Direction='Outbound'},
...
@{Name='✖ [BLOCK IF NOT USING] WinHttpAutoProxySvc';Program='C:\Windows\System32\svchost.exe';Service='WinHttpAutoProxySvc';Protocol='Any';Action='Block';Profile='Any';Direction='Outbound'},
@{Name='✖ [BLOCK IF NOT USING] Winmgmt';Program='C:\Windows\System32\svchost.exe';Service='Winmgmt';Protocol='Any';Action='Block';Profile='Any';Direction='Outbound'},
@{Name='✖ [BLOCK IF NOT USING] wisvc';Program='C:\Windows\System32\svchost.exe';Service='wisvc';Protocol='Any';Action='Block';Profile='Any';Direction='Outbound'},
@{Name='✖ [BLOCK IF NOT USING] wmiApSrv';Program='C:\Windows\System32\svchost.exe';Service='wmiApSrv';Protocol='Any';Action='Block';Profile='Any';Direction='Outbound'},
