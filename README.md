...
@{Name='✔️ Allow Web traffic HTTPS OUTBOUND TCP (encrypted)';Protocol='TCP';RPort='443';Action='Allow';Profile='Any';Direction='Outbound'},
@{Name='✔️ Allow Web traffic QUIC HTTP3 OUTBOUND UDP (encrypted)';Protocol='UDP';RPort='443';Action='Allow';Profile='Any';Direction='Outbound'},
@{Name='✔️ Disable/Enable Block Web traffic HTTP OUTBOUND TCP (unencrypted)';Protocol='TCP';RPort='80';Action='Block';Profile='Any';Direction='Outbound';Enabled='False'},
...
@{Name='✖ [BLOCK IF NOT USING] Dnscache (mDNS/Local Discovery)';Program='C:\Windows\System32\svchost.exe';Service='Dnscache';Protocol='UDP';RPort='5353';Action='Block';Profile='Any';Direction='Outbound'},
